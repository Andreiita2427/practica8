...
public class ShoppingItemDB {
    ...
    public void insertElement(String productName) {
        ...
        contValues .put(ShoppingElementEntry.COLUMN_NAME_TITLE, productName);
        dbHelper.getWritableDatabase().insert(ShoppingElementEntry.TABLE_NAME, null, contValues);
    ...
    public void deleteItem(ShoppingItem shoppingItem) {
        ...
        String[] posicion = {shoppingItem.getName()};
        dbHelper.getWritableDatabase().delete(ShoppingElementEntry.TABLE_NAME,
                ShoppingElementEntry.COLUMN_NAME_TITLE + "LIKE ?", posicion);
